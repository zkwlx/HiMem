...
namespace {
    ...
    auto is_static_method(uintptr_t method) {
        ...
        return (get_method_access_flags(method) & kAccStatic) != 0;
    }
    ...
    auto is_direct_method(uintptr_t method) {
        ...
        return (get_method_access_flags(method) &
                ((kAccStatic | kAccPrivate) | kAccConstructor)) != 0;
    }

    auto is_native_method(uintptr_t method) {
        uintptr_t kAccNative = 256U;
        return (get_method_access_flags(method) & kAccNative) != 0;
    }
    ...
    auto is_quick_resolution_stub(
        ...
        return ((Read4(AccessField(class_linker, 168U)) == entry_point)
    ...
    auto is_quick_to_interpreter_bridge(
        ...
        uint32_t class_linker = Read4(AccessField(runtime, 336U));
        uintptr_t entry_points = AccessField(AccessField(thread, 136U), 156U);
        return ((Read4(AccessField(class_linker, 180U)) == entry_point) ||
    ...
    auto is_quick_generic_jni_stub(
        ...
        uint32_t class_linker = Read4(AccessField(runtime, 336U));
        uintptr_t entry_points = AccessField(AccessField(thread, 136U), 156U);
        return ((Read4(AccessField(class_linker, 176U)) == entry_point) ||
...
auto unwind_900(unwind_callback_t _unwind_callback, void *_unwind_data) -> bool {
    ...
    while ((mstack != 0U)) {
        uint32_t quick_frame = (Read4(AccessField(AccessField(mstack, 0U), 0U)) & (~1U));
